...
export default function RegisterPage() {
  const { isLoggedIn, isInitializing, register } = useTransaction();
  ...
  async function onSubmit(values: UserRegister) {
    ...
    try {
      ...
      toast({
        ...
        description: response.meta.message || `Selamat datang! Silakan login.`,
      });
      router.push('/login');
      ...
      toast({
        ...
        description: error.meta?.message || 'Terjadi kesalahan.',
      });
    } finally {
        setIsLoading(false);
    }
